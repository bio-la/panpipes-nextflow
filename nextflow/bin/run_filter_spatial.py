...
from funcs.processing import remove_unused_categories
from funcs.io import write_obs, read_yaml, dictionary_stripper
...
if not os.path.exists("./tables"):
    os.mkdir("./tables")
if not os.path.exists("./filtered.data"):
    os.mkdir("./filtered.data")
...
L.info("Saving updated obs in a metadata tsv file to './tables/" + output_prefix + "_cell_metadata.tsv'")
write_obs(sdata["table"], output_prefix=os.path.join("./tables/",output_prefix), output_suffix="_cell_metadata.tsv")
