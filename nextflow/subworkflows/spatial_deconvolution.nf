...
include { tangram } from '../modules/spatial_deconvolution/run_tangram.nf'
...
workflow spatial_deconvolution {
    ...
    cell2location(input_spatial, params.input_singlecell,params.feature_selection_gene_list,params.feature_selection_remove_mt) 

    }

    if (params.run_tangram == "True"){

        tangram(input_spatial, params.input_singlecell, params.feature_selection_gene_csv,params.feature_selection_labels_key,
        params.feature_selection_layer, params.feature_selection_n_genes, params.feature_selection_test_method,params.feature_selection_correction_method,
        params.model_labels_key, params.model_num_epochs, params.model_device, params.model_kwargs)
